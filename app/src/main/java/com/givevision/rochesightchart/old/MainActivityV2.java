...
import com.givevision.rochesightchart.AndroidUtils;
import com.givevision.rochesightchart.LearnMachine;
import com.givevision.rochesightchart.R;
import com.givevision.rochesightchart.SleepThread;
...
public class MainActivityV2 extends Activity implements  RecognitionListener  {
...
//                say("try again",false);
    ...
    private class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<MainActivityV2> activityReference;

        SetupTask(MainActivityV2 activity) {
            if (Util.DEBUG) {
